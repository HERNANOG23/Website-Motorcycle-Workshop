...
<head>
  ...
  <title>Login Daniel Motos</title>
...
<div class="login-logo">
  ...
  <div class="card">
    ...
    <div class="card text-white bg-primary">
      <img class="card-img-top" src="log.jpeg" width="150" height="90">
        <div class="card-body"style="background-color:rgb(211, 84, 0)">
        <h4 class="card-title">Daniel Motos</h4>
        <p class="card-text">Ingresa tu email contraseña</p>
      </div>
    </div>
