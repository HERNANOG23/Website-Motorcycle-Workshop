...
if($result){
    echo '<meta http-equiv="refresh" content="0; url=panel.php?modulo=contacto&mensaje=Contacto Creado"/>';
}else{
    ?>
...
<div class="content-wrapper">
        <section class="content-header">
            <div class="content-fluid">
              <div class="row mb-2">    
                 <div class="col-sm-6"style="padding-left: 200">
        ...
        <section class="content">
           <div class="row">
              <div class="col-12">
                <div class="card">
                  <div class="card-body">
                   <form action="panel.php?modulo=crearContacto" method="post" id="crearContacto">
