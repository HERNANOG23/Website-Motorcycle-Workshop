...
<head>
  ...
  <meta name="description" content="DANIEL MOTOS es un taller de motocicletas">
...
<div class="wrapper">
 <!-- Control Sidebar -->
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="panel.php" class="brand-link">
      <img src="logo.png" alt="Daniel Motos Logo" class="brand-image img-circle elevation-3"
           style="opacity: .8">
      <span class="brand-text font-weight-light">Daniel Motos</span>
    </a>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="panel.php?modulo=clientes" class="nav-link <?php echo ($modulo=="clientes" || $modulo=="editarCliente" || $modulo=="crearCliente")? "active":" ";?>">
                <i class="fas fa-hard-hat"></i>
                  <p>Usuarios Cliente</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="panel.php?modulo=producto" class="nav-link <?php echo ($modulo=="producto" || $modulo=="editarProducto" || $modulo=="crearProducto")? "active":" ";?>">
                <i class="fas fa-motorcycle"></i>
                  <p>Productos</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="panel.php?modulo=contacto" class="nav-link <?php echo ($modulo=="contacto"|| $modulo=="editarContacto" || $modulo=="crearContacto")? "active":" ";?>">
  ...
  <!-- Content Wrapper. Contains page content -->
      ...
      //incluir modulos o paginas de cliente
      if($modulo=="clientes"){
      ...
      //incluir modulos o paginas de productos
      if($modulo=="producto"){
      ...
      if($modulo=="editarContacto"){
        include_once "editarContacto.php";
      }
  ...
  <div class="login-logo">
           ...
           style="opacity: .8">
            ...
            <div class="header__texto">
                ...
                <p class="header" align ="center">Tu moto en manos profesionales</p>
...
<script>
 $(document).ready(function(){
   $(".borrar").click(function (e){
     e.preventDefault();
     var eliminar=confirm("Esta seguro de eliminar el elemento?");
     if(eliminar==true){
