      ...
      <p class="login-box-msg">Iniciar Sesion</p>
       <?php
         ...
         if(isset($_REQUEST['login'])){
           ...
           //validar que los datos en la tabla usuarios sean los correctos para ingresar
           if($row){
             //variables de sesion
             ...
             ?>             
              ...
              <div class="alert alert-danger" role="alert">               
                <strong>Error en Login! <img src="error.png" alt="Error en Login" width="100"></strong> 
              </div>
